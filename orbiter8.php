<div id="orbiter8" class="pt-4 pb-4">
  <div class="row p-4">

    <div class="p-4">
      <a href="https://orbiter8.com"><img src="orbiter-8-splash.png" class="img-fluid" /></a>
    </div>
    ...
    <div class="col-xs-10 col-sm-10 col-md-8 col-lg-10 col-xl-8">
      <div class="row">
        <div class="col-lg-6 col-xl-4">
          <a href="https://Orbiter8.com"><img src="orbiter-8-screen.png" class="img-fluid rounded pr-4 pl-r pt-2"></a>
        </div >
